...
def uploadSeason():
    ...
    total_club_info_list = json.dumps(seasons, indent=2)
    upload_blob_from_memory(bucket_name, total_club_info_list, season_file)
...
def uploadClubStats():
    for season in seasons:
        ...
        total_player_info_list = json.dumps(total_club_stats, indent=2)
        upload_blob_from_memory(bucket_name, total_player_info_list, player_stats_file)
